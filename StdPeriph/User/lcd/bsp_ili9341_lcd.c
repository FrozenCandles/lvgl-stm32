...
inline void                 ILI9341_Write_Cmd           ( uint16_t usCmd );
inline void                 ILI9341_Write_Data          ( uint16_t usData );
inline uint16_t             ILI9341_Read_Data           ( void );
...
/**
  ...
  * @retval 无
  */	
static inline void ILI9341_Write_Cmd ( uint16_t usCmd )
{
...
/**
  ...
  * @retval 无
  */	
static inline void ILI9341_Write_Data ( uint16_t usData )
{
