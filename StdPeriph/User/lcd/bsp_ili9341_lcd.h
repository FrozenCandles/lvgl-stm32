...
//#define ILI9341_Write_Cmd ( usCmd ) *( __IO uint16_t * )( FSMC_Addr_ILI9341_CMD ) = usCmd
//#define ILI9341_Write_Data ( usData ) * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA ) = usData
//#define ILI9341_Read_Data() ( * ( __IO uint16_t * ) ( FSMC_Addr_ILI9341_DATA ) )
